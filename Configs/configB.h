...
#define CONFIG_H_
    ...
    #define FOND_ECRAN      "Images\\wolf.bmp"    //fond d'ecran


    /*Police*/
    #define POLICE          "Polices\\Lavi.ttf"  //La police utilisee
    #define TAILLE_POLICE   27                   //La taille de la police (faites un test sous word !)
    #define COULEUR_POLICE  {255, 0, 0}          //La couleur de la police
