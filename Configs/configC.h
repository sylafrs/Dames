...
#define CONFIG_H_
    ...
    #define FOND_ECRAN      "Images\\perro.bmp"    //fond d'ecran


    /*Police*/
    #define POLICE          "Polices\\black.ttf"  //La police utilisee
    #define TAILLE_POLICE   30                    //La taille de la police (faites un test sous word !)
    #define COULEUR_POLICE  {255, 255, 255}          //La couleur de la police
    ...
    #define FOND_TRANSPARENT   128                              //rend le fond (image) transparent
    ...
    #define SCORE_REINE_CADRE_Y   90                         //Nombre de dames (ordonee, en pixels)
    ...
    /*Message de fin*/
    #define FIN_VAINQUEUR_X        TITRE_X-200                //message du vainqueur (abscisse, en px)
    #define FIN_VAINQUEUR_Y        TITRE_Y+100                // (ordonnee en pixel)
    #define FIN_STATS_X            TITRE_X-200                //stats du vainqueur (abscisse en pixel)
    #define FIN_STATS_Y            FIN_VAINQUEUR_Y+30         // (ordonnee en pixel)
    #define FIN_MESS_REVANCHE_X    TITRE_X-200                //position du message de revanche (absci)
    #define FIN_MESS_REVANCHE_Y    (ECRAN_Y-texte->h)/2       // (ordonnee en pixel)
    #define FIN_BOUTON_OUI_X       (ECRAN_X-TAILLE_BOUTON_X)/2-200 //position du boutton 'oui' (abscisse)
